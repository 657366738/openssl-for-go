...
extern int X_BN_hex2bn_E(RSA*rsa,const char*in);
extern int X_BN_hex2bn_N(RSA*rsa,const char*in);
extern int X_BN_bn2bin_N(RSA*rsa,unsigned char*ot);
extern int X_BN_bn2bin_E(RSA*rsa,unsigned char*ot);
extern RSA* X_PEM_read_bio_RSAPrivateKey(BIO*bp,RSA**rsa);
extern RSA* X_PEM_read_bio_RSAPublicKey(BIO*bp,RSA**rsa);
/* SSL methods */
